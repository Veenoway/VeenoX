        ...
        <div className="flex items-center md:justify-start md:w-auto w-full justify-between gap-3 relative text-white h-full">
          <Popover>
            <PopoverTrigger className="h-full min-w-fit">
              <div className="flex items-center mr-1 whitespace-nowrap w-fit min-w-fit md:border-r border-borderColor h-full cursor-pointer">
                <img
            ...
            <PopoverContent
              sideOffset={0}
              className="md:transform-x-[10px] w-screen md:w-[550px] bg-secondary border-b border-x-0 border-t-0 md:border border-borderColor shadow-2xl "
            >
              <PairSelector params={params as FavoriteProps as never} />
            </PopoverContent>
          </Popover>
          <div className="flex items-center overflow-x-scroll no-scrollbar md:min-w-[800px]">
            <p
              ...
              <div>
                <TooltipProvider>
                  <Tooltip delayDuration={0}>
                    ...
                    >
                      Used for margining, computing unrealized PnL,
                      liquidations, and triggering TP/SL orders.
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                ...
                <TooltipProvider>
                  <Tooltip delayDuration={0}>
                    ...
                    >
                      ...
                      short positions, or vice versa, to maintain balance
                      between supply and demand in the derivatives market.
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                ...
                <TooltipProvider>
                  <Tooltip delayDuration={0}>
                    ...
                    <TooltipContent
                      ...
                      className="h-fit overflow-clip max-w-[220px] w-full p-2 bg-secondary border border-borderColor shadow-xl whitespace-pre-wrap"
                    >
                      The total outstanding position of all users on this
                      contract
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
