...
>(({ className, close, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    onClick={close}
    className={cn(
      `fixed inset-0 z-[52] bg-black opacity-30 blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0`,
      className
    )}
    {...props}
  />
